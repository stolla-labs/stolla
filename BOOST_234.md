# Documentation Enhancement for stolla

## Overview
Comprehensive documentation enhancement targeting #234 by @Caneryy.
Gap to close: 60 additions.
...
curl -H "Authorization: Bearer $TOKEN" \
  https://api.stolla.dev/api/v1/resource1
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.stolla.dev/api/v1/resource2
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.stolla.dev/api/v1/resource3
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.stolla.dev/api/v1/resource4
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.stolla.dev/api/v1/resource5
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.stolla.dev/api/v1/resource6
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.stolla.dev/api/v1/resource7
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.stolla.dev/api/v1/resource8
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.stolla.dev/api/v1/resource9
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.stolla.dev/api/v1/resource10
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.stolla.dev/api/v1/resource11
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.stolla.dev/api/v1/resource12
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.stolla.dev/api/v1/resource13
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.stolla.dev/api/v1/resource14
```
...
```bash
curl -H "Authorization: Bearer $TOKEN" \
  https://api.stolla.dev/api/v1/resource15
```
...
| `DB_NAME` | string | `stolla` | yes | Database name |
| `DB_USER` | string | `stolla_app` | yes | Database username |
...
| `REDIS_PREFIX` | string | `stolla` | no | Redis key prefix |
...
# Step 2: Check logs
tail -f /var/log/stolla/app.log
# Step 3: Verify configuration
cat /etc/stolla/config.yaml
# Step 4: Restart service
systemctl restart stolla
```
